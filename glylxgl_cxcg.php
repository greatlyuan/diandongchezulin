	...
	<body style=" width: 100%; height: 100%; margin: 0; padding: 0;">
						...
						<table height="303" border="1" align="center" style="width: 100%; margin-top: 30px;">
							<tr>
                            	<td height="50" colspan="5" align="center">
                    				...
                    				<a href="glylxgl_cxcg.php" style="border: 1px solid #aaa;padding: 0.2rem 0.5rem;border-radius: 3px;background: #eee; font-size:12px;">查询</a>
            ...
            <script>
				...
				$('#myModal_bj .btn.btn-success').click(function(){
					window.location.href='http://localhost/diandongchezulin/lxgl.php';
				});
