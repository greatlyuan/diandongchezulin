...
<html xmlns="http://www.w3.org/1999/xhtml" style="width: 100%; height: 100%; margin: 0; padding: 0; ">
	...
	<body style=" width: 100%; height: 100%; margin: 0; padding: 0;">
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="f6f6f6">
				...
				<tr bgcolor="#b2222b">
                    <td style="width: 50%; border: 1px solid #FFF;" align="center">
                    	<a href="ygdlcg.php" style="padding: 6px 0; color: #fff; display: inline-block; width: 100%; height: 100%;"">车辆信息管理</a>
                    </td>
                    <td style="width: 50%; border: 1px solid #FFF;" align="center">
                    	<a href="ygddgl.php" style="padding: 6px 0; color: #fff; display: inline-block; width: 100%; height: 100%;">车辆订单管理</a>
                    </td>
                </tr>
				<tr>
